    ...
    def generate_report(results: Dict[str, Dict[str, List[float]]], config: MPGAConfig) -> None:
        ...
        for name, history in results.items():
            ...
            if is_bottleneck:
                ...
                recovery = MPGAMetricsEvaluator.calculate_recovery_rate(history["best_fitness"], config.asteroid_gen)
            ...
            print(f"{name:<35} | {final_err:>12.4f} | {auc:>14.2f} | {conv_str:>10} | {debt_str:>10} | {rec_str:>10}")
