...
from iga_core.boundary import LoadCase, FixedSupport, PointLoad, PeriodicBoundary
...
class AdvancedBenchmarks:
    ...
    def paper_wang_2018_robust_cantilever():
        ...
        load_case = LoadCase().add(FixedSupport(left_nodes)) \
                              .add(PointLoad(bottom_right, fy=-1500.0))
